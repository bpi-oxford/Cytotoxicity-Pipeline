...
def test_CrossCellContactMeasures_mpi():
    ...
    if rank==0:
        ...
        # kirpc541
        CANCER_IMAGE_PATH_PATTERN = "/mnt/KIRPC602/DATA/UTSE/2023_10_17_Nyeso1HCT116_1G4CD8_icam_FR10s_0p1mlperh/roi/register_denoise_gamma_channel_merged/cancer/*.tif"
        TCELL_IMAGE_PATH_PATTERN = "/mnt/KIRPC602/DATA/UTSE/2023_10_17_Nyeso1HCT116_1G4CD8_icam_FR10s_0p1mlperh/roi/register_denoise_gamma_channel_merged/tcell/*.tif"

        CANCER_LABEL_PATH_PATTERN = "/mnt/KIRPC602/DATA/UTSE/2023_10_17_Nyeso1HCT116_1G4CD8_icam_FR10s_0p1mlperh/roi/register_denoise_gamma_channel_merged_masks/cancer/*.tif"
        TCELL_LABEL_PATH_PATTERN = "/mnt/KIRPC602/DATA/UTSE/2023_10_17_Nyeso1HCT116_1G4CD8_icam_FR10s_0p1mlperh/roi/register_denoise_gamma_channel_merged_masks/tcell/*.tif"

        OUTPUT_DIR = "/mnt/KIRPC602/DATA/UTSE/2023_10_17_Nyeso1HCT116_1G4CD8_icam_FR10s_0p1mlperh/test_res"
        ...
        start_time = time.time()
        cccm = CrossCellContactMeasures(verbose=VERBOSE,parallel_backend="MPI")
